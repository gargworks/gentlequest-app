...
void main() {
  group('J03: Compliance guard screen', () {
    ...
    testWidgets('age gate "I am 18 or older" button is present', (tester) async {
      await tester.pumpWidget(const MaterialApp(home: ComplianceGuardScreen()));
      await tester.pump(const Duration(milliseconds: 500));
      await tester.pump();
    ...
    testWidgets('age gate "I am under 18" button is present', (tester) async {
      await tester.pumpWidget(const MaterialApp(home: ComplianceGuardScreen()));
      await tester.pump(const Duration(milliseconds: 500));
      await tester.pump();
    ...
    testWidgets('"I am 18 or older" tap does not crash', (tester) async {
      await tester.pumpWidget(const MaterialApp(home: ComplianceGuardScreen()));
      await tester.pump(const Duration(milliseconds: 500));
      await tester.pump();
    ...
    testWidgets('"I am under 18" tap does not crash', (tester) async {
      await tester.pumpWidget(const MaterialApp(home: ComplianceGuardScreen()));
      await tester.pump(const Duration(milliseconds: 500));
      await tester.pump();
