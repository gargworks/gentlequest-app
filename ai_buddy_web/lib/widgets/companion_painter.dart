...
class CompanionPainter extends CustomPainter {
  ...
  bool shouldRepaint(covariant CompanionPainter old) =>
      stage != old.stage || simplified != old.simplified;
  ...
  void _shadow(Canvas canvas) {
    ...
    _oval(canvas, 48, 82, 25, 4.5, GQColors.moodSlateLavender, opacity: 0.6);
  }
  ...
  void _paintSeed(Canvas canvas) {
    _shadow(canvas);
    _oval(canvas, 48, 71, 9.5, 12, GQColors.moodCoralPeach);
    if (!simplified) {
      _oval(canvas, 44.5, 66, 2.8, 3.8, GQColors.moodGood, opacity: 0.9);
    }
  }
  ...
  void _paintSprout(Canvas canvas) {
    _shadow(canvas);
    _rrect(canvas, 46.25, 58, 3.5, 22, 1.75, GQColors.primary);
    _rotatedOval(canvas, 38, 60, 9, 5.5, GQColors.moodPeri, -16);
    _rotatedOval(canvas, 58, 57, 9, 5.5, GQColors.primary, 16);
  }
  ...
  void _paintSapling(Canvas canvas) {
    _shadow(canvas);
    _rrect(canvas, 45.75, 30, 4.5, 50, 2.25, GQColors.primary);
    _rotatedOval(canvas, 32, 62, 13, 7, GQColors.moodSlateLavender, -22);
    _rotatedOval(canvas, 64, 57, 13, 7, GQColors.moodPeri, 22);
    _rotatedOval(canvas, 34, 45, 12, 6.5, GQColors.moodPeri, -18);
    _rotatedOval(canvas, 62, 40, 12, 6.5, GQColors.primary, 18);
    _circle(canvas, 48, 27, 5, GQColors.moodCoralPeach);
  }
  ...
  void _paintYoungTree(Canvas canvas) {
    _shadow(canvas);
    _rrect(canvas, 44, 48, 8, 32, 4, GQColors.ink2);
    _circle(canvas, 48, 35, 22, GQColors.primary);
    if (!simplified) {
      _circle(canvas, 39, 27, 8.5, GQColors.moodPeri, opacity: 0.5);
      _circle(canvas, 65, 23, 5, GQColors.moodCoralPeach);
    }
  }
  ...
  void _paintMatureTree(Canvas canvas) {
    _shadow(canvas);
    _rrect(canvas, 43, 44, 10, 36, 5, GQColors.ink2);
    _circle(canvas, 29, 40, 17, GQColors.moodPeri);
    _circle(canvas, 67, 40, 17, GQColors.primaryDk);
    _circle(canvas, 48, 25, 21, GQColors.primary);
    if (!simplified) {
      _circle(canvas, 69, 20, 5.5, GQColors.moodCoralPeach);
      _circle(canvas, 30, 27, 4, GQColors.moodGood);
    }
  }
}
