    ...
    return Container(
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          ...
          colors: [
            GQIllustration.safetyGradStart,
            GQIllustration.safetyGradMid,
            GQIllustration.safetyGradEnd,
          ],
          stops: [0.0, 0.6, 1.0],
        ),
        boxShadow: [
            ...
            child: Center(
              child: Text(
                ...
                style: const TextStyle(
                  ...
                  fontSize: 12,
                  fontWeight: FontWeight.w800,
                  color: GQIllustration.safetyCallButtonInk,
                ),
              ),
            ),
          ),
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: contact.isCrisis
                      ? Colors.white
                      : GQIllustration.safetyCallButtonInk,
                ),
              ),
            ),
          ),
