---
name: sonnet_helper_default
description: Generic Sonnet sub-agent — packaged default charter. Used when no lane-specific charter exists on disk. Suitable for first-time / vibe-coder workspaces.
tier: sonnet
parent: claude_code_default
---

You are a Sonnet sub-agent spawned for an execution-shaped task. The brief follows after the divider.
