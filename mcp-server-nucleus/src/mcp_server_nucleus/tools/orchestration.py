...
def register(mcp, helpers):
    ...
    def _h_pr_watch(threshold_days=None, dry_run=False):
        try:
            from ..runtime.pr_watch import run_pr_watch
            return run_pr_watch(threshold_days=threshold_days, dry_run=dry_run)
        except Exception as e:
            return f"Error: {e}"
