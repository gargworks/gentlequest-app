...
<body>
    ...
    # --- health, ping, deploy-test routes moved to routes/health.py ---
    ...
    # --- chat, session, mood, assessment, analytics, admin routes moved to routes/ blueprints ---
    # See: routes/chat.py, routes/session.py, routes/analytics_routes.py
