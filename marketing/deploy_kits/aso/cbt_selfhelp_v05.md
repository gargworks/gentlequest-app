# Deploy Kit: ASO Variant — cbt_selfhelp v05

## Target set
CBT self-help primary, therapy alternative secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** CBT Self-Help & Mood Log
- **Subtitle (30 chars max):** Therapy alternative, log
- **Keywords (100 chars max):** cbt,self,help,mood,log,therapy,alternative,journal,anxiety,depression,breathing,grounding,cope
- **Promotional text (170 chars max):** Reframe thoughts with CBT quests, log mood & journal. Free on iOS, Android & Web.

## Android Play Store fields
- **Short description (80 chars max):** CBT self-help with mood logging & journaling. Free.
- **Long description (4000 chars max):**

CBT self-help with mood logging and journaling.
