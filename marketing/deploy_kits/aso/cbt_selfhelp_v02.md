# Deploy Kit: ASO Variant — cbt_selfhelp v02

## Target set
CBT self-help primary, therapy alternative secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** CBT Quests & Self-Help
- **Subtitle (30 chars max):** Therapy alternative, mood
- **Keywords (100 chars max):** cbt,quests,self,help,therapy,alternative,mood,anxiety,depression,journal,breathing,grounding,cope
- **Promotional text (170 chars max):** Complete CBT quests that reframe thoughts. Log mood & journal. Free on iOS, Android & Web.

## Android Play Store fields
- **Short description (80 chars max):** CBT quests as a gentle therapy alternative. Free app.
- **Long description (4000 chars max):**

Self-help quests inspired by cognitive behavioral therapy.
...
- **New title:** CBT Quests & Self-Help
- **Change:** Replaces the generic live title with a keyword-targeted title that leads with 'CBT' and 'self-help' instead of the generic 'mental health companion' phrasing. Subtitle shifts to 'Therapy alternative, mood' to reinforce the cbt-selfhelp angle. iOS keywords and promotional text are rewritten to prioritize 'CBT' and 'self-help' over generic 'mental health' terms, improving discoverability for high-intent searches.
