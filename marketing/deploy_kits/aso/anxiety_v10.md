# Deploy Kit: ASO Variant — anxiety v10

## Target set
Anxiety primary, depression secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** Anxiety Calm: CBT & Mood
- **Subtitle (30 chars max):** Ground, breathe, journal
- **Keywords (100 chars max):** anxiety,calm,cbt,mood,ground,breathe,journal,depression,stress,cope,relief,wellness,track
- **Promotional text (170 chars max):** Stay calm with CBT quests, grounding, breathing & mood tracking. Free on iOS, Android & Web.

## Android Play Store fields
- **Short description (80 chars max):** Stay calm with CBT quests, grounding, breathing & mood. Free.
- **Long description (4000 chars max):**

Stay calm and build resilience against anxiety.
