# Deploy Kit: ASO Variant — cbt_selfhelp v09

## Target set
CBT self-help primary, therapy alternative secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** CBT Self-Help Mood Tracker
- **Subtitle (30 chars max):** Quests, breathing, ground
- **Keywords (100 chars max):** cbt,self,help,mood,tracker,quests,breathing,grounding,anxiety,depression,journal,therapy,cope
- **Promotional text (170 chars max):** Track mood while completing CBT self-help quests. Journal & breathe. Free on iOS & Android.

## Android Play Store fields
- **Short description (80 chars max):** CBT self-help mood tracker with quests. Free app.
- **Long description (4000 chars max):**

Track your mood while you work through CBT quests.
