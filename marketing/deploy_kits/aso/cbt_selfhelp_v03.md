# Deploy Kit: ASO Variant — cbt_selfhelp v03

## Target set
CBT self-help primary, therapy alternative secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** GentleQuest CBT Companion
- **Subtitle (30 chars max):** Self-help, journal
- **Keywords (100 chars max):** cbt,companion,self,help,journal,breathe,mood,anxiety,depression,grounding,therapy,alternative,cope
- **Promotional text (170 chars max):** Your CBT companion: reframe thoughts, journal & track mood. Free on iOS, Android & Web.

## Android Play Store fields
- **Short description (80 chars max):** Your CBT companion for self-help quests & mood. Free.
- **Long description (4000 chars max):**

A companion for CBT-style self-help and reflection.
