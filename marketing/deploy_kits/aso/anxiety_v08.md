# Deploy Kit: ASO Variant — anxiety v08

## Target set
Anxiety primary, depression secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** Ease Anxiety with GentleQuest
- **Subtitle (30 chars max):** Mood, CBT, breathing
- **Keywords (100 chars max):** anxiety,ease,mood,cbt,quests,breathing,grounding,depression,stress,calm,cope,journal,relief
- **Promotional text (170 chars max):** Ease anxiety with mood tracking, CBT quests, breathing & grounding. Free on iOS, Android & Web.

## Android Play Store fields
- **Short description (80 chars max):** Ease anxiety with mood tracking, CBT quests & breathing. Free.
- **Long description (4000 chars max):**

Ease anxiety gently, day by day.
