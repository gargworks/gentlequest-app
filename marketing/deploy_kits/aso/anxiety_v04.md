# Deploy Kit: ASO Variant — anxiety v04

## Target set
Anxiety primary, depression secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** Calm Anxiety: GentleQuest
- **Subtitle (30 chars max):** CBT, breathing, ground
- **Keywords (100 chars max):** anxiety,calm,cbt,breathing,grounding,mood,depression,stress,journal,cope,relax,relief,wellness
- **Promotional text (170 chars max):** Calm anxiety with breathing and grounding. Build coping skills with CBT quests. Free on iOS & Android.

## Android Play Store fields
- **Short description (80 chars max):** Calm anxiety with breathing, grounding & CBT quests. Free.
- **Long description (4000 chars max):**

Calm your anxiety with proven, gentle techniques.
