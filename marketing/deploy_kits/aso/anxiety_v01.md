# Deploy Kit: ASO Variant — anxiety v01

## Target set
Anxiety primary, depression secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** GentleQuest: Anxiety Relief
- **Subtitle (30 chars max):** Calm anxiety with CBT
- **Keywords (100 chars max):** anxiety,calm,relief,stress,cbt,breathing,grounding,mood,depression,worry,panic,relax,cope,wellness
- **Promotional text (170 chars max):** Calm anxiety with breathing, grounding & CBT quests. Track mood daily. Free on iOS, Android & Web.

## Android Play Store fields
- **Short description (80 chars max):** Calm anxiety with CBT quests, breathing & grounding. Free app.
- **Long description (4000 chars max):**

Find calm when anxiety strikes.
