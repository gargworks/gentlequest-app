# Deploy Kit: ASO Variant — cbt_selfhelp v10

## Target set
CBT self-help primary, therapy alternative secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** GentleQuest: CBT & Calm
- **Subtitle (30 chars max):** Self-help, mood, journal
- **Keywords (100 chars max):** cbt,calm,self,help,mood,journal,anxiety,depression,breathing,grounding,therapy,alternative,cope
- **Promotional text (170 chars max):** CBT self-help quests for a calmer mind. Track mood & journal. Free on iOS, Android & Web.

## Android Play Store fields
- **Short description (80 chars max):** CBT self-help for calm: quests, mood & journaling. Free.
- **Long description (4000 chars max):**

CBT self-help for a calmer, clearer mind.
