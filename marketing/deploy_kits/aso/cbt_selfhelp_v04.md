# Deploy Kit: ASO Variant — cbt_selfhelp v04

## Target set
CBT self-help primary, therapy alternative secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** Self-Help CBT: GentleQuest
- **Subtitle (30 chars max):** Reframe, track, ground
- **Keywords (100 chars max):** self,help,cbt,reframe,track,ground,mood,anxiety,depression,journal,breathing,therapy,alternative
- **Promotional text (170 chars max):** Self-help CBT quests reframe thoughts & build coping skills. Free on iOS, Android & Web.

## Android Play Store fields
- **Short description (80 chars max):** Self-help CBT quests to reframe thoughts & ground. Free.
- **Long description (4000 chars max):**

Self-help that feels like a gentle adventure.
