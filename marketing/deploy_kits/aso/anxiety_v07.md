# Deploy Kit: ASO Variant — anxiety v07

## Target set
Anxiety primary, depression secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** Anxiety Companion: GentleQuest
- **Subtitle (30 chars max):** Breathe, ground, journal
- **Keywords (100 chars max):** anxiety,companion,breathe,ground,journal,mood,cbt,depression,stress,calm,cope,relief,wellness
- **Promotional text (170 chars max):** Your anxiety companion: breathe, ground, journal & complete CBT quests. Free on iOS & Android.

## Android Play Store fields
- **Short description (80 chars max):** Your anxiety companion for breathing & CBT quests. Free.
- **Long description (4000 chars max):**

A gentle companion for anxious days and nights.
...
- **New title:** Anxiety Companion: GentleQuest
