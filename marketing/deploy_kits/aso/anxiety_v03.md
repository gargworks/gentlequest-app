# Deploy Kit: ASO Variant — anxiety v03

## Target set
Anxiety primary, depression secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** GentleQuest Anxiety Tracker
- **Subtitle (30 chars max):** Track anxiety & mood
- **Keywords (100 chars max):** anxiety,tracker,mood,depression,calm,cbt,breathing,grounding,journal,stress,cope,relief,wellness
- **Promotional text (170 chars max):** Track anxiety and mood, then calm down with breathing, grounding & CBT quests. Free on iOS & Android.

## Android Play Store fields
- **Short description (80 chars max):** Track anxiety, log mood & practice CBT quests. Free app.
- **Long description (4000 chars max):**

Track your anxiety and mood, then act with calming tools.
