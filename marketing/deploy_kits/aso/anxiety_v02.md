# Deploy Kit: ASO Variant — anxiety v02

## Target set
Anxiety primary, depression secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** Anxiety Help & CBT Quests
- **Subtitle (30 chars max):** Breathe, ground, track
- **Keywords (100 chars max):** anxiety,help,cbt,quests,breathe,ground,mood,track,depression,stress,calm,cope,panic,relief
- **Promotional text (170 chars max):** Ease anxiety with breathing and grounding. Reframe worries with CBT quests. Free on iOS, Android & Web.

## Android Play Store fields
- **Short description (80 chars max):** Ease anxiety with breathing, grounding & CBT quests. Free.
- **Long description (4000 chars max):**

Ease anxious thoughts with gentle, guided tools.
