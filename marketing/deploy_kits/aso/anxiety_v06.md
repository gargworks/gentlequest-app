# Deploy Kit: ASO Variant — anxiety v06

## Target set
Anxiety primary, depression secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** GentleQuest: Stress & Anxiety
- **Subtitle (30 chars max):** Cope with calm CBT
- **Keywords (100 chars max):** anxiety,stress,cope,calm,cbt,quests,breathing,grounding,mood,depression,journal,relief,relax
- **Promotional text (170 chars max):** Cope with stress & anxiety using CBT quests, breathing & grounding. Free on iOS, Android & Web.

## Android Play Store fields
- **Short description (80 chars max):** Cope with stress & anxiety via CBT quests & breathing. Free.
- **Long description (4000 chars max):**

Cope with stress and anxiety, one gentle quest at a time.
...
- **New title:** GentleQuest: Stress & Anxiety
- **Change:** Replaces the generic live title with a keyword-targeted title that retains the 'GentleQuest' brand prefix but adds 'anxiety' as the core value proposition. Subtitle shifts to 'Cope with calm CBT' to reinforce the anxiety angle. iOS keywords and promotional text are rewritten to prioritize 'anxiety' over generic 'mental health' terms, improving discoverability for high-intent searches.
