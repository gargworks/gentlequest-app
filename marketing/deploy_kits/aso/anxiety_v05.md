# Deploy Kit: ASO Variant — anxiety v05

## Target set
Anxiety primary, depression secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** Anxiety Relief & Mood Log
- **Subtitle (30 chars max):** Journal, breathe, reframe
- **Keywords (100 chars max):** anxiety,relief,mood,log,journal,breathe,reframe,cbt,depression,stress,calm,cope,grounding
- **Promotional text (170 chars max):** Relieve anxiety with mood logging, journaling & CBT quests. Free on iOS, Android & gentlequest.app.

## Android Play Store fields
- **Short description (80 chars max):** Relieve anxiety with mood logging, journaling & CBT. Free.
- **Long description (4000 chars max):**

Relieve anxiety by logging, journaling, and reframing.
...
- **New title:** Anxiety Relief & Mood Log
- **Change:** Replaces the generic live title with a keyword-targeted title that leads with 'anxiety' instead of the generic 'mental health companion' phrasing. Subtitle shifts to 'Journal, breathe, reframe' to reinforce the anxiety angle. iOS keywords and promotional text are rewritten to prioritize 'anxiety' over generic 'mental health' terms, improving discoverability for high-intent searches.
