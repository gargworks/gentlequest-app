# Deploy Kit: ASO Variant — anxiety v09

## Target set
Anxiety primary, depression secondary, mood tertiary

## iOS App Store fields
- **Title (30 chars max):** GentleQuest: Worry & Anxiety
- **Subtitle (30 chars max):** Reframe worries, mood
- **Keywords (100 chars max):** anxiety,worry,reframe,mood,cbt,quests,breathing,grounding,depression,stress,calm,cope,journal
- **Promotional text (170 chars max):** Reframe worries with CBT quests. Calm down with breathing & grounding. Free on iOS & Android.

## Android Play Store fields
- **Short description (80 chars max):** Reframe worries with CBT quests, breathing & grounding. Free.
- **Long description (4000 chars max):**

Turn worries into gentle, manageable quests.
