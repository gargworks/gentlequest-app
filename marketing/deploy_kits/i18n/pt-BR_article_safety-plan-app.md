# Deploy Kit: pt-BR — article: safety-plan-app

## Source
- **Translated file:** marketing/i18n/pt-BR/articles/safety-plan-app.md
- **English source:** marketing/seo/articles/safety-plan-app.md — "Safety Plan App: A Calm Tool for Your Hardest Moments"
- **Source article:** marketing/seo/articles/safety-plan-app.md

## Target
- **Language:** Brazilian Portuguese (pt-BR)
- **Asset type:** SEO article (translated)
- **Target URL:** https://gentlequest.app/pt-BR/blog/safety-plan-app (or https://gentlequest.app/blog/safety-plan-app with hreflang)
