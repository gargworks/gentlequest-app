# Deploy Kit: pt-BR — article: cbt-app-free

## Source
- **Translated file:** marketing/i18n/pt-BR/articles/cbt-app-free.md
- **English source:** marketing/seo/articles/cbt-app-free.md — "CBT App Free: No-Cost Tools for Cognitive Behavioral Skills"
- **Source article:** marketing/seo/articles/cbt-app-free.md

## Target
- **Language:** Brazilian Portuguese (pt-BR)
- **Asset type:** SEO article (translated)
- **Target URL:** https://gentlequest.app/pt-BR/blog/cbt-app-free (or https://gentlequest.app/blog/cbt-app-free with hreflang)
