# Deploy Kit: pt-BR — article: free-mental-health-app-no-ads

## Source
- **Translated file:** marketing/i18n/pt-BR/articles/free-mental-health-app-no-ads.md
- **English source:** marketing/seo/articles/free-mental-health-app-no-ads.md — "Free Mental Health App No Ads: Why Ad-Free Should Be the Default"
- **Source article:** marketing/seo/articles/free-mental-health-app-no-ads.md

## Target
- **Language:** Brazilian Portuguese (pt-BR)
- **Asset type:** SEO article (translated)
- **Target URL:** https://gentlequest.app/pt-BR/blog/free-mental-health-app-no-ads (or https://gentlequest.app/blog/free-mental-health-app-no-ads with hreflang)
