# Deploy Kit: pt-BR — article: anxiety-app-no-ads

## Source
- **Translated file:** marketing/i18n/pt-BR/articles/anxiety-app-no-ads.md
- **English source:** marketing/seo/articles/anxiety-app-no-ads.md — "Anxiety App With No Ads: A Calmer, Distraction-Free Option"
- **Source article:** marketing/seo/articles/anxiety-app-no-ads.md

## Target
- **Language:** Brazilian Portuguese (pt-BR)
- **Asset type:** SEO article (translated)
- **Target URL:** https://gentlequest.app/pt-BR/blog/anxiety-app-no-ads (or https://gentlequest.app/blog/anxiety-app-no-ads with hreflang)
