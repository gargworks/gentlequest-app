# Deploy Kit: es — article: mood-tracker-no-streaks

## Source
- **Translated file:** marketing/i18n/es/articles/mood-tracker-no-streaks.md
- **English source:** marketing/seo/articles/mood-tracker-no-streaks.md — "Mood Tracker With No Streaks: Track How You Feel Without the Guilt"
- **Source article:** marketing/seo/articles/mood-tracker-no-streaks.md

## Target
- **Language:** Spanish (es)
- **Asset type:** SEO article (translated)
- **Target URL:** https://gentlequest.app/es/blog/mood-tracker-no-streaks (or https://gentlequest.app/blog/mood-tracker-no-streaks with hreflang)
