# Deploy Kit: pt-BR — article: grounding-exercise-app

## Source
- **Translated file:** marketing/i18n/pt-BR/articles/grounding-exercise-app.md
- **English source:** marketing/seo/articles/grounding-exercise-app.md — "Grounding Exercise App: Tools to Come Back to the Present"
- **Source article:** marketing/seo/articles/grounding-exercise-app.md

## Target
- **Language:** Brazilian Portuguese (pt-BR)
- **Asset type:** SEO article (translated)
- **Target URL:** https://gentlequest.app/pt-BR/blog/grounding-exercise-app (or https://gentlequest.app/blog/grounding-exercise-app with hreflang)
