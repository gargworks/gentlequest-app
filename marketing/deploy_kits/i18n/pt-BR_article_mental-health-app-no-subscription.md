# Deploy Kit: pt-BR — article: mental-health-app-no-subscription

## Source
- **Translated file:** marketing/i18n/pt-BR/articles/mental-health-app-no-subscription.md
- **English source:** marketing/seo/articles/mental-health-app-no-subscription.md — "Mental Health App No Subscription: Tools That Don't Recurringly Charge You"
- **Source article:** marketing/seo/articles/mental-health-app-no-subscription.md

## Target
- **Language:** Brazilian Portuguese (pt-BR)
- **Asset type:** SEO article (translated)
- **Target URL:** https://gentlequest.app/pt-BR/blog/mental-health-app-no-subscription (or https://gentlequest.app/blog/mental-health-app-no-subscription with hreflang)
