# Deploy Kit: pt-BR — article: depression-app-no-ads

## Source
- **Translated file:** marketing/i18n/pt-BR/articles/depression-app-no-ads.md
- **English source:** marketing/seo/articles/depression-app-no-ads.md — "Depression App With No Ads: Quiet Support Without the Sell"
- **Source article:** marketing/seo/articles/depression-app-no-ads.md

## Target
- **Language:** Brazilian Portuguese (pt-BR)
- **Asset type:** SEO article (translated)
- **Target URL:** https://gentlequest.app/pt-BR/blog/depression-app-no-ads (or https://gentlequest.app/blog/depression-app-no-ads with hreflang)
