# Deploy Kit: hi — article: breathing-exercise-app-free

## Source
- **Translated file:** marketing/i18n/hi/articles/breathing-exercise-app-free.md
- **English source:** marketing/seo/articles/breathing-exercise-app-free.md — "Breathing Exercise App Free: No-Cost Tools to Slow down and Calm"
- **Source article:** marketing/seo/articles/breathing-exercise-app-free.md

## Target
- **Language:** Hindi (hi)
- **Asset type:** SEO article (translated)
- **Target URL:** https://gentlequest.app/hi/blog/breathing-exercise-app-free (or https://gentlequest.app/blog/breathing-exercise-app-free with hreflang)
