# Pitch: Michael Torres — The Atlantic

## Contact
- Email: mtorres@theatlantic.com
- Twitter: @michaeltorres
- LinkedIn: linkedin.com/in/michaeltorres

## Why GQ fits their beat
Your Atlantic essay on the attention economy's impact on mental health makes GQ's no-ads, no-tracking model a natural fit for your beat. Your focus on technology & psychology means GQ's approach — free, no ads, no tracking, no streaks, built-in safety planning — is directly relevant to your readers who are increasingly skeptical of profit-driven wellness apps.
...
I've been following your recent reporting on technology & psychology, and your piece on attention economy mental health really stood out — the way you addressed the tension between accessibility and quality in digital mental health tools is exactly the conversation we're trying to be part of.
...
## Follow-up sequence
1. Day 3: gentle nudge if no reply — "Hi Michael, just floating this back up in case it got buried. Happy to send more details or a quick demo whenever works for you."
...
3. Day 14: final follow-up, different angle — e.g., the broader industry context of ad-free, no-tracking mental health apps as a counter-movement to data-driven wellness monetization. "Hi Michael, last note from me on this — I think the broader story here is about what happens when a mental health app refuses to monetize user data entirely. Happy to chat if that angle is more interesting to you."
