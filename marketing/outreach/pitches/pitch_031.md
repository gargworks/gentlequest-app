# Pitch: Nadia Ahmed — The Calm Note (Substack)

## Contact
- Email: nadiahmed@substack.com
- Twitter: @nadiahmed
- LinkedIn: linkedin.com/in/nadiahmed

## Why GQ fits their beat
Your Substack newsletter on accessible mental wellness tools for everyday readers makes GQ's free, no-frills approach a natural recommendation. Your focus on mental health newsletters means GQ's approach — free, no ads, no tracking, no streaks, built-in safety planning — is directly relevant to your readers who are increasingly skeptical of profit-driven wellness apps.
...
I've been following your recent newsletter on mental health newsletters, and your piece on accessible mental wellness really stood out — the way you addressed the tension between accessibility and quality in digital mental health tools is exactly the conversation we're trying to be part of.
...
## Follow-up sequence
1. Day 3: gentle nudge if no reply — "Hi Nadia, just floating this back up in case it got buried. Happy to send more details or a quick demo whenever works for you."
...
3. Day 14: final follow-up, different angle — e.g., the broader industry context of ad-free, no-tracking mental health apps as a counter-movement to data-driven wellness monetization. "Hi Nadia, last note from me on this — I think the broader story here is about what happens when a mental health app refuses to monetize user data entirely. Happy to chat if that angle is more interesting to you."
