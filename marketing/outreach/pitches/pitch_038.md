# Pitch: Carlos Mendez — Therapy Notes (Substack)

## Contact
- Email: carlosmendez@substack.com
- Twitter: @carlosmendez
- LinkedIn: linkedin.com/in/carlosmendez

## Why GQ fits their beat
Your Therapy Notes newsletter on bridging clinical and self-help tools makes GQ's safety-plan feature a useful bridge for your readers. Your focus on therapy & mental health insights means GQ's approach — free, no ads, no tracking, no streaks, built-in safety planning — is directly relevant to your readers who are increasingly skeptical of profit-driven wellness apps.
...
I've been following your recent newsletter on therapy & mental health insights, and your piece on clinical self help bridge really stood out — the way you addressed the tension between accessibility and quality in digital mental health tools is exactly the conversation we're trying to be part of.
...
## Follow-up sequence
1. Day 3: gentle nudge if no reply — "Hi Carlos, just floating this back up in case it got buried. Happy to send more details or a quick demo whenever works for you."
