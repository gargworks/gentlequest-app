# Pitch: Mark Stevens — Self Magazine

## Contact
- Email: mark@self.com
- Twitter: @markstevens
- LinkedIn: linkedin.com/in/markstevens

## Why GQ fits their beat
Your Self app reviews focusing on user safety and accessibility make GQ's 18+, no-ads, safety-plan-included model a strong candidate for coverage. Your focus on mental health apps & reviews means GQ's approach — free, no ads, no tracking, no streaks, built-in safety planning — is directly relevant to your readers who are increasingly skeptical of profit-driven wellness apps.
...
I've been following your recent reporting on mental health apps & reviews, and your piece on mental health app reviews really stood out — the way you addressed the tension between accessibility and quality in digital mental health tools is exactly the conversation we're trying to be part of.
...
## Follow-up sequence
1. Day 3: gentle nudge if no reply — "Hi Mark, just floating this back up in case it got buried. Happy to send more details or a quick demo whenever works for you."
