# Pitch: Rowan Kelly — TikTok (@rowankellyheals)

## Contact
- Email: rowan@creator.com
- Twitter: @rowankellyheals
- LinkedIn: linkedin.com/in/rowankelly

## Why GQ fits their beat
Your TikTok trauma-informed mental health content for 125k+ followers makes GQ's gentle, safety-plan-included approach relevant to your audience. Your focus on trauma-informed mental health means GQ's approach — free, no ads, no tracking, no streaks, built-in safety planning — is directly relevant to your followers who are increasingly skeptical of profit-driven wellness apps.
...
I've been following your recent content on trauma-informed mental health, and your piece on trauma informed tools really stood out — the way you addressed the tension between accessibility and quality in digital mental health tools is exactly the conversation we're trying to be part of.
...
## Follow-up sequence
1. Day 3: gentle nudge if no reply — "Hi Rowan, just floating this back up in case it got buried. Happy to send more details or a quick demo whenever works for you."
...
3. Day 14: final follow-up, different angle — e.g., the broader industry context of ad-free, no-tracking mental health apps as a counter-movement to data-driven wellness monetization. "Hi Rowan, last note from me on this — I think the broader story here is about what happens when a mental health app refuses to monetize user data entirely. Happy to chat if that angle is more interesting to you."
