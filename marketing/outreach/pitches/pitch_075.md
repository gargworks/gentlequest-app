# Pitch: Avery Chen — TikTok (@averychenmental)

## Contact
- Email: avery@creator.com
- Twitter: @averychenmental
- LinkedIn: linkedin.com/in/averychen

## Why GQ fits their beat
Your TikTok mental health education content for 120k+ followers makes GQ's evidence-informed mood tracking a tool worth recommending. Your focus on mental health education means GQ's approach — free, no ads, no tracking, no streaks, built-in safety planning — is directly relevant to your followers who are increasingly skeptical of profit-driven wellness apps.
...
I've been following your recent content on mental health education, and your piece on mental health education really stood out — the way you addressed the tension between accessibility and quality in digital mental health tools is exactly the conversation we're trying to be part of.
...
## Follow-up sequence
1. Day 3: gentle nudge if no reply — "Hi Avery, just floating this back up in case it got buried. Happy to send more details or a quick demo whenever works for you."
...
3. Day 14: final follow-up, different angle — e.g., the broader industry context of ad-free, no-tracking mental health apps as a counter-movement to data-driven wellness monetization. "Hi Avery, last note from me on this — I think the broader story here is about what happens when a mental health app refuses to monetize user data entirely. Happy to chat if that angle is more interesting to you."
