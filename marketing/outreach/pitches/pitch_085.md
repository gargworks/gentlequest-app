# Pitch: Dakota Reyes — TikTok (@dakotareyesmindful)

## Contact
- Email: dakota@creator.com
- Twitter: @dakotareyesmindful
- LinkedIn: linkedin.com/in/dakotareyes

## Why GQ fits their beat
Your TikTok mindful living content for 145k+ followers makes GQ's no-pressure, streak-free mood tracking a natural recommendation. Your focus on mindful living & mental health means GQ's approach — free, no ads, no tracking, no streaks, built-in safety planning — is directly relevant to your followers who are increasingly skeptical of profit-driven wellness apps.
...
I've been following your recent content on mindful living & mental health, and your piece on mindful living really stood out — the way you addressed the tension between accessibility and quality in digital mental health tools is exactly the conversation we're trying to be part of.
...
## Follow-up sequence
1. Day 3: gentle nudge if no reply — "Hi Dakota, just floating this back up in case it got buried. Happy to send more details or a quick demo whenever works for you."
...
3. Day 14: final follow-up, different angle — e.g., the broader industry context of ad-free, no-tracking mental health apps as a counter-movement to data-driven wellness monetization. "Hi Dakota, last note from me on this — I think the broader story here is about what happens when a mental health app refuses to monetize user data entirely. Happy to chat if that angle is more interesting to you."
