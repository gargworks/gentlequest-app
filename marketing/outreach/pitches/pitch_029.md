# Pitch: Laura Bennett — Vice

## Contact
- Email: laura@vice.com
- Twitter: @laurabennett
- LinkedIn: linkedin.com/in/laurabennett

## Why GQ fits their beat
Your Vice reporting on the intersection of internet culture and mental health makes GQ's no-tracking, community-free, private approach relevant. Your focus on digital culture & mental health means GQ's approach — free, no ads, no tracking, no streaks, built-in safety planning — is directly relevant to your readers who are increasingly skeptical of profit-driven wellness apps.
...
I've been following your recent reporting on digital culture & mental health, and your piece on internet culture mental health really stood out — the way you addressed the tension between accessibility and quality in digital mental health tools is exactly the conversation we're trying to be part of.
...
## Follow-up sequence
1. Day 3: gentle nudge if no reply — "Hi Laura, just floating this back up in case it got buried. Happy to send more details or a quick demo whenever works for you."
...
3. Day 14: final follow-up, different angle — e.g., the broader industry context of ad-free, no-tracking mental health apps as a counter-movement to data-driven wellness monetization. "Hi Laura, last note from me on this — I think the broader story here is about what happens when a mental health app refuses to monetize user data entirely. Happy to chat if that angle is more interesting to you."
