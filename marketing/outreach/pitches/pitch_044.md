# Pitch: Noah Bennett — Digital Detox Notes (Substack)

## Contact
- Email: noahbennett@substack.com
- Twitter: @noahbennett
- LinkedIn: linkedin.com/in/noahbennett

## Why GQ fits their beat
Your Digital Detox Notes on reducing harmful digital habits makes GQ's no-ads, no-tracking, no-engagement-manipulation model a rare positive tech story. Your focus on digital wellness & detox means GQ's approach — free, no ads, no tracking, no streaks, built-in safety planning — is directly relevant to your readers who are increasingly skeptical of profit-driven wellness apps.
...
I've been following your recent newsletter on digital wellness & detox, and your piece on reducing harmful digital habits really stood out — the way you addressed the tension between accessibility and quality in digital mental health tools is exactly the conversation we're trying to be part of.
...
## Follow-up sequence
1. Day 3: gentle nudge if no reply — "Hi Noah, just floating this back up in case it got buried. Happy to send more details or a quick demo whenever works for you."
...
3. Day 14: final follow-up, different angle — e.g., the broader industry context of ad-free, no-tracking mental health apps as a counter-movement to data-driven wellness monetization. "Hi Noah, last note from me on this — I think the broader story here is about what happens when a mental health app refuses to monetize user data entirely. Happy to chat if that angle is more interesting to you."
