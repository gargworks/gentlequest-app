# Pitch: Sara Kim — The Burnout Project

## Contact
- Email: sara@burnoutproject.com
- Twitter: @sarakim
- LinkedIn: linkedin.com/in/sarakim

## Why GQ fits their beat
Your Burnout Project podcast on workplace mental health tools makes GQ's free, private mood tracking a practical resource for burned-out professionals. Your focus on burnout & workplace mental health means GQ's approach — free, no ads, no tracking, no streaks, built-in safety planning — is directly relevant to your readers who are increasingly skeptical of profit-driven wellness apps.
...
I've been following your recent reporting on burnout & workplace mental health, and your piece on workplace mental health tools really stood out — the way you addressed the tension between accessibility and quality in digital mental health tools is exactly the conversation we're trying to be part of.
...
## Follow-up sequence
1. Day 3: gentle nudge if no reply — "Hi Sara, just floating this back up in case it got buried. Happy to send more details or a quick demo whenever works for you."
...
3. Day 14: final follow-up, different angle — e.g., the broader industry context of ad-free, no-tracking mental health apps as a counter-movement to data-driven wellness monetization. "Hi Sara, last note from me on this — I think the broader story here is about what happens when a mental health app refuses to monetize user data entirely. Happy to chat if that angle is more interesting to you."
