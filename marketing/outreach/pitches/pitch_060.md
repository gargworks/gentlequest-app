# Pitch: Alex Rivera — The Mood Podcast

## Contact
- Email: alex@moodpod.com
- Twitter: @alexrivera
- LinkedIn: linkedin.com/in/alexrivera

## Why GQ fits their beat
Your Mood Podcast on mood tracking and emotional awareness makes GQ's privacy-first, no-data-harvesting mood tracker a standout tool to review. Your focus on mood science & tracking means GQ's approach — free, no ads, no tracking, no streaks, built-in safety planning — is directly relevant to your listeners who are increasingly skeptical of profit-driven wellness apps.
...
I've been following your recent episodes on mood science & tracking, and your piece on mood tracking tools really stood out — the way you addressed the tension between accessibility and quality in digital mental health tools is exactly the conversation we're trying to be part of.
...
## Follow-up sequence
1. Day 3: gentle nudge if no reply — "Hi Alex, just floating this back up in case it got buried. Happy to send more details or a quick demo whenever works for you."
...
3. Day 14: final follow-up, different angle — e.g., the broader industry context of ad-free, no-tracking mental health apps as a counter-movement to data-driven wellness monetization. "Hi Alex, last note from me on this — I think the broader story here is about what happens when a mental health app refuses to monetize user data entirely. Happy to chat if that angle is more interesting to you."
