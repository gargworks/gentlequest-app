# Archived: Nuclear Engine Operational Constitution

> **Preserved 2026-08-27.** This is a design exploration of a multi-agent
> operating org — the "Nuclear Engine" constitution, self-dated
> December 27, 2025 (matches its introduction in the repo history). The
> tooling it describes (`agent_manager.py`, `.brain/ledger/state.json`
> sprint mechanics as used here, the CORE_SYN/VISION_ONE/etc. codename
> roster) was not built. It is preserved as thinking, and removed from
> `AGENTS.md` — the live entry-point doc agents actually read — so that
> agents do not attempt to run a protocol that doesn't exist.
