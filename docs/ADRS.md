...
- ADR-007: Stage 1 criterion (B), native D14 retention instrument — native iOS+Android, persisted in funnel snapshots, first complete read 2026-10-09 — see `docs/gates/ADR-007-stage1-retention-instrument.md`
