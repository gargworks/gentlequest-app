...
| R1D2  | Wellness Dashboard      | R1    | GentleQuest_Wellness_Dashboard.html         | ai_buddy_web/lib/dhiwise/presentation/wellness_dashboard_screen/wellness_dashboard_screen.dart | 0 | in-flight — URL TBD (unified PR with R1D3) |
| R1D3  | Dashboard States        | R2    | GentleQuest_Dashboard_States.html           | ai_buddy_web/lib/dhiwise/presentation/wellness_dashboard_screen/wellness_dashboard_screen.dart | 2  | in-flight — URL TBD (unified PR with R1D2; supersedes #18) |
...
| R1D5  | Mood Reflection         | R1    | GentleQuest_Mood_Reflection.html            | ai_buddy_web/lib/widgets/mood_reflection_sheet.dart                                         | 1    | in-flight   |
| R1D6  | Chat First Turn         | R1    | GentleQuest_Chat_First_Turn.html            | ai_buddy_web/lib/screens/interactive_chat_screen.dart                                       | 1    | in-flight   |
| R1D7  | Chat Active States      | R2    | GentleQuest_Chat_Active_States.html         | ai_buddy_web/lib/screens/interactive_chat_screen.dart                                       | 2    | in-flight — https://github.com/eidetic-works/ai-mental-health-assistant/pull/TBD |
| R1D8  | Clinical Assessment     | R2    | GentleQuest_Clinical_Assessment.html        | ai_buddy_web/lib/screens/clinical_assessment_screen.dart                                    | 2    | in-flight — https://github.com/eidetic-works/ai-mental-health-assistant/pull/32 |
...
| R1D10 | Compliance Block        | R1    | GentleQuest_Compliance_Block.html           | ai_buddy_web/lib/screens/compliance_guard_screen.dart                                       | 0    | in-flight   |
| R1D11 | Compliance Extensions   | R2    | GentleQuest_Compliance_Extensions.html      | ai_buddy_web/lib/screens/compliance_guard_screen.dart                                       | 2    | in-flight — https://github.com/eidetic-works/ai-mental-health-assistant/pull/33 |
| R1D12 | Offline States          | R3    | GentleQuest_Offline_States.html             | ai_buddy_web/lib/screens/interactive_chat_screen.dart (inline banner + cold-start overlay)  | 3    | in-flight — https://github.com/eidetic-works/ai-mental-health-assistant/pull/31 |
| R1D13 | Quests                  | R1    | GentleQuest_Quests.html                     | ai_buddy_web/lib/screens/quest_screen.dart                                                  | 4    | in-flight — URL TBD |
...
| R1D15 | Weekly Review           | R3    | GentleQuest_Weekly_Review.html              | ai_buddy_web/lib/screens/weekly_review_screen.dart                                          | 3    | in-flight — URL TBD |
| R1D16 | Exercise Cards          | R2    | GentleQuest_Exercise_Cards.html             | ai_buddy_web/lib/widgets/exercise_card_scaffold.dart + lib/screens/exercise_scaffold_screen.dart | 2    | in-flight — https://github.com/eidetic-works/ai-mental-health-assistant/pull/34 |
| R1D17 | Library                 | R2    | GentleQuest_Library.html                    | ai_buddy_web/lib/screens/resource_library_screen.dart                                       | 2    | in-flight — https://github.com/eidetic-works/ai-mental-health-assistant/pull/28 |
