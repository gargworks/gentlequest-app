#!/usr/bin/env python3
"""Shim: delegates to mcp_server_nucleus.mirror.hook.

Keeps the existing Claude Code hook wiring (scripts/relay_inbox_hook.py)
...
from mcp_server_nucleus.mirror.hook import main  # noqa: E402
